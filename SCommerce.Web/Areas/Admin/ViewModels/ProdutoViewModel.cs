...
namespace SCommerce.Web.Areas.Admin.ViewModels
{
    public class ProdutoViewModel : BaseViewModels
    {
        ...
        public static Produto Mapear(ProdutoViewModel produto)
        {
            try
            {
                var saida = new Produto(Guid.Empty);
                if (produto != null)
                {
                    saida = new Produto(Guid.Empty)
                    {
                        Altura = produto.Altura,
                        Ativo = produto.Ativo,
                        Atualizado = produto.Atualizado,
                        ...
                        UPC = produto.UPC,
                        UploadArquivos = produto.UploadArquivos,
                        imagens = ProdutoImagemViewModel.Mapear(produto.imagensProduto)
                    };
                }
                return saida;
            }
        ...
        public static ICollection<Produto> Mapear(ICollection<ProdutoViewModel> produtos)
        {
            try
            {
                var saida = new Collection<Produto>();
                if (produtos != null)
                {
                    foreach (var item in produtos)
                    {
