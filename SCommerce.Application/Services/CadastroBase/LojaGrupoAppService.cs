...
{
    public class LojaGrupoAppService : AppServiceBase<LojaGrupo>, ILojaGrupoAppService
    {
        public LojaGrupoAppService(IServiceBase<LojaGrupo> serviceBase) : base(serviceBase)
        {
        }
    }
}
