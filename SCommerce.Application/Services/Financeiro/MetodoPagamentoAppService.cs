...
{
    public class MetodoPagamentoAppService : AppServiceBase<MetodoPagamento>, IMetodoPagamentoAppService
    {
        public MetodoPagamentoAppService(IServiceBase<MetodoPagamento> serviceBase) : base(serviceBase)
        {
        }
    }
}
