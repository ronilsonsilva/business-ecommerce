...
{
    public class PrecoEspecificoAppService : AppServiceBase<PrecoEspecifico>, IPrecoEspecificoAppService
    {
        public PrecoEspecificoAppService(IServiceBase<PrecoEspecifico> serviceBase) : base(serviceBase)
        {
        }
    }
}
