...
{
    public class OCDetalhesAppService : AppServiceBase<OCDetalhes>, IOCDetalhesAppService
    {
        public OCDetalhesAppService(IServiceBase<OCDetalhes> serviceBase) : base(serviceBase)
        {
        }
    }
}
