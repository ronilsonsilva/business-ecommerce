...
{
    public class OCFaturaAppService : AppServiceBase<OCFatura>, IOCFaturaAppService
    {
        public OCFaturaAppService(IServiceBase<OCFatura> serviceBase) : base(serviceBase)
        {
        }
    }
}
